  ...
  <section class="content max-w-screen-md box">
    <div class="prose">
      <h2 class="text-center text-primary">
        Urlaub vom 11. April bis 22. April 2022
      </h2>
      ...
      <p>
        Ab dem 25. März sind wir zu den regulären Sprechzeiten wieder für Sie da!
        Unsere Zahnarztpraxis wird vertreten durch:
      </p>
      ...
      <div class="columns">
        <div class="column">
          ...
          <p class="text-size-sm leading-heading mb-lg">
            Dr.-Friedrich-Wolf-Straße 2<br />
            07545 Gera
          </p>
          <div class="columns items-center gap-sm">
            <div class="column-full sm:column-narrow">
              <a href="tel:03658001160" class="button-primary text-size-sm p-2">
                <CarbonPhoneFilled class="mr-1" aria-hidden="true" />
                03 65 / 800 11 60
              </a>
            </div>
            <div class="column-auto">
              <p class="text-rose-600 text-size-sm leading-heading">
                <strong>Achtung</strong>: Eine vorherige telefonische Anmeldung
